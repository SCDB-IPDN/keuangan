...
<!-- page content -->
 ...
 <div class="content-wrapper settingPage">
    ...
    <section class="content">
      <!-- Default box -->
      <?php if($this->session->userdata ('user_details')[0]->user_type == "admin" || $this->session->userdata ('user_details')[0]->user_type == "sulsel"){?>
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Chart Rekapitulasi Alokasi Pagu Per Bagian Kampus IPDN Sulawesi Selatan Berdasarkan Petunjuk Operasional Kegiatan (POK)</b></h3>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-lg-12">
              <div class="col-md-8 col-md-offset-1 aboutshift">
                <div class="table-responsive">
                  <p class="text-center">Rekapitulasi Alokasi Pagu Per Bagian Kampus IPDN Sulsel</p>
                  <div id="graph"></div>
                </div>
              </div>
            </div>
      ...
      <?php }else{ ?>
        <p>* Anda tidak memiliki akses untuk melihat keuangan Kampus IPDN Sulawesi Selatan</p>
