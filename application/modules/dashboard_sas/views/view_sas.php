              ...
              <tbody>
                ...
                <?php foreach (json_decode($data, true) as $x): ?>
                  <tr>
                    ...
                    <?php if (isset($x['id_c']))  { ?>
                      <td class="v-center"><a href="<?= '/keuangan/dashboard_sas/'.$x['id_c']; ?>" class='btn btn-primary mr-1'>DETAIL C</a></td>
                    <?php } elseif (isset($x['id_b'])) { ?>
                      <td class="v-center"><a href="<?= '/keuangan/dashboard_sas/'.$x['id_b']; ?>" class='btn btn-primary mr-1'>DETAIL B</a></td>
                    <?php } elseif (isset($x['kode_satker'])){ ?>
                      <td class="v-center"><a href="<?= '/keuangan/dashboard_sas/'.$x['kode_satker']; ?>" class='btn btn-primary mr-1'>DETAIL K</a></td>
                    <?php }else{ ?>
