...
<!-- page content -->
 ...
 <div class="content-wrapper settingPage">
    ...
    <section class="content">
      <!-- Default box -->
      <?php if($this->session->userdata ('user_details')[0]->user_type == "admin" || $this->session->userdata ('user_details')[0]->user_type == "biro III" || $this->session->userdata ('user_details')[0]->user_type == "Member"){?>
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title"><b>BIRO III : Chart Rekapitulasi Alokasi Pagu Per Unit Kerja/Bagian Berdasarkan Petunjuk Operasional Kegiatan (POK)</b></h3>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-lg-12">
      ...
      <?php }else{ ?>
        <p>* Anda tidak memiliki akses untuk melihat keuangan Biro III</p>
    ...
    <script type="text/javascript">
      $(document).ready(function() {  
        ...
        var table = $('#example').DataTable({ 
            ...
            "ajax": url+"keprajaan/keprajaan_page",
