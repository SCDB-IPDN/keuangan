...
<!-- page content -->
 ...
 <div class="content-wrapper settingPage">
    ...
    <section class="content">
      <!-- Default box -->
      <?php if($this->session->userdata ('user_details')[0]->user_type == "admin" || $this->session->userdata ('user_details')[0]->user_type == "ntb"){?>
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Chart Rekapitulasi Alokasi Pagu IPDN Kampus Nusa Tenggara Barat Berdasarkan Petunjuk Operasional Kegiatan (POK)</b></h3>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-lg-12">
      ...
      <?php }else{ ?>
        <p>* Anda tidak memiliki akses untuk melihat keuangan IPDN Kampus Nusa Tenggara Barat</p>
